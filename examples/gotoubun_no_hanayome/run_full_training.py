...
if __name__ == "__main__":
    ...
    final_model = main_training_loop(
        ...
        dataset,
        EPOCHS,
        model=resnet_18_internal_normalizer(len(classes)),
    ...
    eval_on_folder(dataset, final_model, TEST_DATA_DIR, EVAL_IMAGES_LIMIT, device=DEVICE, save_prediction_image_name="yotsubanet_predictions_global_normalization_manga_removed.png")
